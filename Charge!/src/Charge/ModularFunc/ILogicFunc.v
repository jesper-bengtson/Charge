...
Section ILogicCast.
  ...
  Definition ILOps_tyArrD t u (IL : ILogicOps (typD (typ2 t u))) : ILogicOps (typD t -> typD u) :=
    eq_rect_r ILogicOps IL (eq_sym (typ2_cast t u)).

  Definition ILOps_tyArrR t u (IL : ILogicOps (typD t -> typD u)) : ILogicOps (typD (typ2 t u)) :=
